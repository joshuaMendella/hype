...
## What's been built (as of 2026-07-03, updated session 14)
...
- 6 entity types: item, brand, place, person, event, org (org = employer/school/team, session 14) — each has tier 1/2/3 parameter stacks in entityTypes.ts. User self-facts (age, home_location) are NOT entities — they route to profiles.base_profile JSONB.
