...
**Category claim:** the first personal assistant where every find is one you asked for.

**The model, stated straight:** Finds are a core product value, not a monetization story. People have always wanted what good recommendations promise: the right deal, the show two towns over, the thing they were about to buy anyway. What they hate is what got bolted on — irrelevance, surveillance, and powerlessness. Hype removes all three: suggestions are hyper-tailored because they come only from what the user chose to share, kept in a graph the user can see, correct, and delete — and it asks before every find, so the user, not anyone else, owns the moment. Finds are a reason people join and *stay* — the **first** of four, listed ahead of the graph's give-back trio of recall, proactive utility, and reflection (principle 10) — never a fee to be excused. Advertisers and affiliates pay for consent-confirmed referrals, which is why Hype costs users nothing; free is a consequence of the model, a footnote, never the pitch. *(Positioning history: reframed 2026-07-12 as "finds, not ads"; evolved 2026-07-13 — finds repositioned from honest-monetization-story to core product value, and the phrase "a feature, not a fee" retired even as messaging: it is unclear, and it keeps the fee frame alive by arguing against it. **The lexicon rule is absolute on every user-facing surface, including the marketing site: "find," "offer," or "suggestion" — never "ad(s)."** A paid find still carries a clear "Sponsored" label. Internal/ops language keeps "advertising/referrals.")*
...
9. **Finds are a core product value — sell them as a benefit, never as the price of "free."** Hyper-tailored suggestions from real interests, with full transparency and per-moment control, are one of the reasons people join and stay. Product and marketing lead with the value on both sides — "it remembers you," *and* "finds you'd actually want, only when you ask" — as two halves of the same product, not a value and its bill. Any "free because…" framing is banned; free is a consequence of the model, stated as a footnote, never the pitch. The phrase "a feature, not a fee" is retired even as internal messaging — it argues against the fee frame and thereby keeps it alive; show the value instead. **User-facing lexicon: "find," "offer," "suggestion" — never "ad(s)"** — which also retires the old slogan "Be in control of your ads. Only see what you want, when you want it." (surviving working line: *"Only what you want, when you want it."*). *(Evolved 2026-07-13; supersedes the 2026-07-12 "feature, not a fee" wording, which itself superseded the "consent-only ads is the answer to 'why is it free?'" framing.)*
