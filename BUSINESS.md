...
**Category claim:** the first personal assistant with consent-only ads.
...
9. **The assistant leads with utility, the ad model earns trust.** Nobody downloads an app for its ad format. Marketing and product both lead with "it remembers you"; consent-only ads is the answer to "why is it free?" — stated proudly, never inverted.
