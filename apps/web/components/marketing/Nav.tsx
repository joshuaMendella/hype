    ...
    >
      <nav className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            href="/signup"
            className="rounded-lg bg-white px-4 py-2 text-sm font-medium text-black shadow-[0_0_24px_-6px_rgba(255,255,255,0.6)] transition-transform hover:scale-[1.03]"
          >
            Start your graph
          </Link>
        </div>
